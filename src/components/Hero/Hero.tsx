  ...
  return (
    <section className="hero">
      ...
      <section className='card'>
        <img className='animal-image' src="https://images.unsplash.com/photo-1569591159212-b02ea8a9f239?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mjd8fGNhdHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"/>
        <section className='text-block'>
          <h2 className='name'>Kent</h2>
          <section className="location">
            <p>
              <img className='map-pin' src={map} alt='map pin'/>Eskilstuna
            </p>
          </section>
      ...
      <section className='card'>
        <img className='animal-image' src="https://images.unsplash.com/photo-1618252903592-2b8c90c43a6e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Z3VpbmVhJTIwcGlnfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"/>
        <section className='text-block'>
          <h2 className='name'>Åke</h2>
          <section className="location">
            <p>
              <img className='map-pin' src={map} alt='map pin'/>Karlskoga
            </p>
          </section>
