...
const Overlay = ({ visibility, hideOverlay, setPickedAnimal, pickedAnimal, addInterest }: Props) => {
      ...
      <section className={visibility}>
        <section className="overlay-container">
          ...
          <main className="overlay__main overlay__main--column">
            <div>
              <img className="animal-info-image" src={pickedAnimal.image} alt="" />
            ...
            <section className="overlay-info">
              ...
              <div className="animal-info-location">
                <figure className="animal-info-location-pin">
                  <img className="animal-info-location-pin" src={locationPin} alt="location pin" />
                </figure>
